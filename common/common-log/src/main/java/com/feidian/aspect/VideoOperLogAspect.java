...
@Component
@Aspect
public class VideoOperLogAspect {
    @Autowired
    private VideoOperLogService videoOperLogService;

    @AfterReturning(pointcut = "@annotation(controllerLog)", returning = "jsonResult")
    public void doAfterReturning(JoinPoint joinPoint, VideoOperLogAt controllerLog, Object jsonResult) {
        handleLog(joinPoint, controllerLog, null, jsonResult);
    }

    protected void handleLog(final JoinPoint joinPoint, VideoOperLogAt controllerLog, final Exception e, Object jsonResult) {
        try {
