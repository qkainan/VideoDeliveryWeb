<template>
  <div class="addgoods">
    ...
    <div class="name-money">
        ...
        <Input v-model="value" prefix="logo-usd" placeholder="Enter number" style="width: 200px" />
        <template #content>
    ...
    <div class="goodsinfo">
    <Input v-model="value2" maxlength="100" show-word-limit="true" type="textarea" placeholder="商品描述" style="width: 100%" />
    </div>
 </div>
</template>
